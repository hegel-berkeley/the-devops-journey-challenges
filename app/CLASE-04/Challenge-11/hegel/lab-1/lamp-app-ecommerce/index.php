    ...
    <body>
                    ...
                    <div class="col-md-2 p0">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="index.html">
                                <img src="https://roxs.295devops.com/static/media/Upstream-8.fd5001b0a762ac84490c.png" width="50" alt="">
                            </a>
                        </div>
                    </div>
        ...
        <section class="best_business_area row">
            ...
            <div class="row it_works">
              <?php
                        $link = mysqli_connect($_ENV['DB_HOST'], $_ENV['DB_USER'], $_ENV['DB_PASSWORD'], $_ENV['DB_DATABASE']);
                        if ($link) {
        ...
        <footer class="footer_area row">
            <div class="container custom-container">
                ...
                <div class="copy_right_area">
                    <h4 class="copy_right">© KodeKloud 2019|Fixed RoxsRoss 2023 | All Rights Reserved</h4>
                </div>
            </div>
        </footer>
